...
const Navbar = () => {
  ...
  return (
    <header className="w-full">
      {/* ── NEWS TICKER ── */}
      <div
        className={`fixed top-0 left-0 right-0 z-[110] bg-blue-900 text-white py-2 overflow-hidden border-b border-blue-800 transition-all duration-500 ease-in-out ${
      ...
      <nav
        className={`fixed left-0 right-0 z-[100] transition-all duration-500 ease-in-out border-b ${
          isScrolled
            ? 'bg-white/90 backdrop-blur-md border-blue-100 py-3 shadow-md'
            ...
            >
              ...
              {showBranchMenu && branches?.length > 0 && (
                <div className='absolute top-full left-1/2 -translate-x-1/2 w-80 pt-4'>
                  <div className='bg-white border border-blue-100 shadow-2xl overflow-hidden'
