    ...
    <div style={{ fontFamily: "'Georgia', serif" }} className="bg-white">
      ...
      <div className="px-6 md:px-16 mb-20">
        <div className="flex flex-col md:flex-row gap-0 items-stretch">
          ...
          {/* info panel */}
          <div className="flex-1 border border-violet-100 px-8 md:px-12 py-10 flex flex-col gap-8">

            <div>
              <span className="uppercase tracking-[0.35em] text-[10px] text-violet-400 font-sans block mb-2">
                Our Main Branch
              </span>
            ...
            <div>
              ...
              <button
                className="group relative overflow-hidden bg-violet-600 text-white px-10 py-4 font-sans text-xs tracking-widest uppercase font-bold inline-flex items-center gap-3"
