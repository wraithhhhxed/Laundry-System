        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-1.5'>
            ...
            <input
              ...
              className='w-full px-4 py-2.5 border border-blue-100 font-sans text-sm text-neutral-700 placeholder-neutral-300 focus:outline-none focus:border--400 transition-colors'
            />
          </div>
