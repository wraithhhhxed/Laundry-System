        ...
        <div className='max-w-sm w-full mx-auto'>
          ...
          <div className='mb-8'>
            ...
            <p className='font-sans text-sm text-neutral-400 mt-2'>
              {sent
                ? <>We sent a reset link to <span className='text-violet-500 font-medium'>{email}</span>. It expires in 15 minutes.</>
          ...
          {!sent ? (
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
              <div className='flex flex-col gap-1.5'>
                ...
                <input
                  ...
                  className='w-full px-4 py-3 border border-violet-100 font-sans text-sm text-neutral-700 placeholder-neutral-300 focus:outline-none focus:border-violet-400 transition-colors bg-white'
                  required
                />
              </div>
            ...
            <div className='border border-violet-100 p-6 text-center'>
              <p className='font-sans text-xs text-neutral-400 uppercase tracking-widest'>
                Didn't receive it? Check your spam folder.
              </p>
              <button
                onClick={() => { setSent(false); setEmail('') }}
                className='mt-4 font-sans text-[10px] text-violet-400 hover:text-violet-600 uppercase tracking-widest transition-colors'
              >
